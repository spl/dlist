...
--
-- This is internal module. It exports 'DList' constructor.
--
-- The difference function @[a] -> [a]@ should be composition of
-- 'id', @x:@ or @xs ++@. Otherwise 'DList' will not work.
-- In a sense, 'DList' is /bigger/ than a @[]@.
--
-----------------------------------------------------------------------------
